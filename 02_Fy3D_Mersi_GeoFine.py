...
GCP=[119.69048888,32.26087777]
ImagePoint = [119.6907555,32.2763917]
Distance = [GCP[0]-ImagePoint[0],GCP[1]-ImagePoint[1]]
###Read Fy3 file
filename = r"J:\ZJQX\zjqx_dc\Satellite\秸秆焚烧\风云3D火点监测\FY3D_MERSI_GBAL_L1_20221115_0530_0250M_MS(2).HDF"
Handle  = h5py.File(filename, "r+")
Lat = Handle["Geolocation/Latitude"].value
Lon = Handle["Geolocation/Longitude"].value
Lat_new =Lat +Distance[1]
Lon_new=Lon + Distance[0]
